...
export const clickName = {
  ...
  CLICK_ON_ALREADY_A_MEMBER_NAVIGATE_TO_LOGIN:
    "clickOnAlreadyAMemberNavigateToLogin",
};
export const successActionName = {
  ...
  CHANGE_PASSWORD_OTP_VERIFY_SUCCESSFULLY:
    "changePasswordOTPVerifySuccessfully",
