...
import { eventName, screenName, clickName, errorActionName, successActionName, yesNoArray } from '../../../../utils/Constant';
...
const RowdetailForm = (props: any) => {
  ...
  useEffect(() => {
    if (isEdit) {
      ...
      console.log("SelectedItem==========", route?.params?.spreadSheetRow?.items)
      ...
      if (isEdit) {
        columnList.map((element: any, index: any) => {
          ...
          if (element.column_Type == "Yes/No") {
            ...
            element['defaultValue'] = rowVal[element.column_Name] ? rowVal[element.column_Name] : null
            console.log("index========", index)
