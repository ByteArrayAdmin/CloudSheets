                        ...
                        subchildren={
                            <View style={{ paddingVertical: 15 }}>
                                <View style={{ marginLeft: 20 }}>
                                    <Text style={styles.headingTextStyle}>{labels.SubscriptionScreen.Email_Address}</Text>
                                </View>
                                <InputField
                                    name="email"
                                    control={control}
                                ...
                                <View style={{ marginLeft: 20,marginTop:20 }}>
                                    <Text style={styles.headingTextStyle}>{labels.SubscriptionScreen.Subject}</Text>
                                </View>
                                <InputField
                                    name="subject"
                                    control={control}
                                ...
                                />
                                <View style={{ marginLeft: 20,marginTop:20 }}>
                                    <Text style={styles.headingTextStyle}>{labels.SubscriptionScreen.Discription}</Text>
                                </View>
                                <InputField
                                    name="description"
                                    control={control}
                                ...
                                />
                                <View>
                                    <Button Register={labels.SubscriptionScreen.submit} onPress={handleSubmit(submitCustomerForm)} />
                                </View>
                            </View>
                        }
                    />
